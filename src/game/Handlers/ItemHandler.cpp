...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_SPLIT_ITEM");
    uint8 srcbag, srcslot, dstbag, dstslot, count;

    recv_data >> srcbag >> srcslot >> dstbag >> dstslot >> count;
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "STORAGE: receive srcbag = %u, srcslot = %u, dstbag = %u, dstslot = %u, count = %u", srcbag, srcslot, dstbag, dstslot, count);
...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_SWAP_INV_ITEM");
    uint8 srcslot, dstslot;

    recv_data >> srcslot >> dstslot;
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "STORAGE: receive srcslot = %u, dstslot = %u", srcslot, dstslot);
...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_SWAP_ITEM");
    uint8 dstbag, dstslot, srcbag, srcslot;

    recv_data >> dstbag >> dstslot >> srcbag >> srcslot ;
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "STORAGE: receive srcbag = %u, srcslot = %u, dstbag = %u, dstslot = %u", srcbag, srcslot, dstbag, dstslot);
...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_AUTOEQUIP_ITEM");
    uint8 srcbag, srcslot;

    recv_data >> srcbag >> srcslot;
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "STORAGE: receive srcbag = %u, srcslot = %u", srcbag, srcslot);
...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_DESTROYITEM");
    uint8 bag, slot, count, data1, data2, data3;

    recv_data >> bag >> slot >> count >> data1 >> data2 >> data3;
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "STORAGE: receive bag = %u, slot = %u, count = %u", bag, slot, count);
...
void WorldSession::HandleItemQuerySingleOpcode(WorldPacket& recv_data)
{
    ...
    sLog.Out(LOG_BASIC, LOG_LVL_DETAIL, "STORAGE: Item Query = %u", item);
...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_READ_ITEM");

    uint8 bag, slot;
    recv_data >> bag >> slot;

    //sLog.Out(LOG_BASIC, LOG_LVL_DETAIL, "STORAGE: Read bag = %u, slot = %u", bag, slot);
    Item *pItem = _player->GetItemByPos(bag, slot);
    ...
    if (pItem && pItem->GetProto()->PageText)
    {
        ...
        if (msg == EQUIP_ERR_OK)
        {
            ...
            sLog.Out(LOG_BASIC, LOG_LVL_DETAIL, "STORAGE: Item page sent");
        }
        else
        {
            ...
            sLog.Out(LOG_BASIC, LOG_LVL_DETAIL, "STORAGE: Unable to read item");
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Received CMSG_PAGE_TEXT_QUERY");
    ...
    sLog.Out(LOG_BASIC, LOG_LVL_DETAIL, "Packet Info: itemid: %u guid: %s", itemid, guid.GetString().c_str());
}

void WorldSession::HandleSellItemOpcode(WorldPacket& recv_data)
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Received CMSG_SELL_ITEM");
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Received CMSG_BUYBACK_ITEM");
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Received CMSG_BUY_ITEM_IN_SLOT");
    ObjectGuid vendorGuid;
    ObjectGuid bagGuid;
    uint32 item;
    uint8 bagslot, count;
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Received CMSG_BUY_ITEM");
    ObjectGuid vendorGuid;
    uint32 item;
    uint8 count, unk1;
...
void WorldSession::HandleListInventoryOpcode(WorldPacket& recv_data)
{
    ...
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Recvd CMSG_LIST_INVENTORY");
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: Sent SMSG_LIST_INVENTORY");
...
{
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_AUTOSTORE_BAG_ITEM");
    uint8 srcbag, srcslot, dstbag;

    recv_data >> srcbag >> srcslot >> dstbag;
    //sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "STORAGE: receive srcbag = %u, srcslot = %u, dstbag = %u", srcbag, srcslot, dstbag);
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_BUY_BANK_SLOT");
    ...
    sLog.Out(LOG_BASIC, LOG_LVL_DETAIL, "PLAYER: Buy bank bag slot, slot number = %u", slot);
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_AUTOBANK_ITEM");
    uint8 srcbag, srcslot;
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_AUTOSTORE_BANK_ITEM");
    uint8 srcbag, srcslot;
...
void WorldSession::HandleSetAmmoOpcode(WorldPacket& recv_data)
{
    ...
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WORLD: CMSG_SET_AMMO");
    uint32 item;
...
{
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "Received opcode CMSG_WRAP_ITEM");
    ...
    sLog.Out(LOG_BASIC, LOG_LVL_DEBUG, "WRAP: receive gift_bag = %u, gift_slot = %u, item_bag = %u, item_slot = %u", gift_bag, gift_slot, item_bag, item_slot);
