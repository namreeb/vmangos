...
void WorldSession::HandleSellItemOpcode(WorldPacket& recv_data)
{
    ...
    if (!pCreature)
    {
        sLog.outDebug("WORLD: HandleSellItemOpcode - %s not found or you can't interact with him.", vendorGuid.GetString().c_str());
...
void WorldSession::HandleBuybackItem(WorldPacket& recv_data)
{
    ...
    if (!pCreature)
    {
        sLog.outDebug("WORLD: HandleBuybackItem - %s not found or you can't interact with him.", vendorGuid.GetString().c_str());
...
void WorldSession::SendListInventory(ObjectGuid vendorguid, uint8 menu_type)
{
    ...
    if (!pCreature)
    {
        sLog.outDebug("WORLD: SendListInventory - %s not found or you can't interact with him.", vendorguid.GetString().c_str());
        _player->SendSellError(SELL_ERR_CANT_FIND_VENDOR, nullptr, ObjectGuid(), 0);
        return;
    }
...
bool WorldSession::CheckBanker(ObjectGuid guid)
{
    ...
    if (guid == GetPlayer()->GetObjectGuid())
    {
        ...
        {
            sLog.outDebug("%s attempt open bank in cheating way.", guid.GetString().c_str());
            return false;
        }
    }
    // banker case
    else
    {
        ...
        {
            sLog.outDebug("Banker %s not found or you can't interact with him.", guid.GetString().c_str());
            return false;
        }
    }
