...
bool ChatHandler::HandleSetValueHelper(Object* target, uint32 field, char* typeStr, char* valStr)
{
    ...
    if (base)
    {
        ...
        sLog.outDebug(GetMangosString(LANG_SET_UINT), guid.GetString().c_str(), field, iValue);
    ...
    else
    {
        ...
        sLog.outDebug(GetMangosString(LANG_SET_FLOAT), guid.GetString().c_str(), field, fValue);
...
bool ChatHandler::HandleGetValueHelper(Object* target, uint32 field, char* typeStr)
{
    ...
    if (base)
    {
        ...
        switch (base)
        {
            case 2:
            {
                ...
                sLog.outDebug(GetMangosString(LANG_GET_BITSTR), guid.GetString().c_str(), field, res.c_str());
                PSendSysMessage(LANG_GET_BITSTR_FIELD, guid.GetString().c_str(), field, res.c_str());
                break;
            }
            case 16:
                sLog.outDebug(GetMangosString(LANG_GET_HEX), guid.GetString().c_str(), field, iValue);
                PSendSysMessage(LANG_GET_HEX_FIELD, guid.GetString().c_str(), field, iValue);
                break;
            case 10:
            default:
                sLog.outDebug(GetMangosString(LANG_GET_UINT), guid.GetString().c_str(), field, iValue);
    ...
    else
    {
        ...
        sLog.outDebug(GetMangosString(LANG_GET_FLOAT), guid.GetString().c_str(), field, fValue);
...
bool ChatHandler::HandlerDebugModValueHelper(Object* target, uint32 field, char* typeStr, char* valStr)
{
    ...
    if (type)
    {
        ...
        switch (type)
        {
            ...
            case 1:                                         // int +
                ...
                sLog.outDebug(GetMangosString(LANG_CHANGE_INT32), guidString, field, iValue, value, value);
                PSendSysMessage(LANG_CHANGE_INT32_FIELD, guidString, field, iValue, value, value);
                break;
            case 2:                                         // |= bit or
                value |= iValue;
                sLog.outDebug(GetMangosString(LANG_CHANGE_HEX), guidString, field, typeStr, iValue, value);
    ...
    else
    {
        ...
        sLog.outDebug(GetMangosString(LANG_CHANGE_FLOAT), guidString, field, fValue, value);
